...
const AdminProfile = () => {
  ...
  return (
    <div className="min-h-screen  flex flex-col items-center  py-10">
      ...
      <div className=" p-5 lg:p-10 border-2 border-blue-500 shadow-md bg-white  w-[300px]  lg:w-[500px]">
       
        <div className="flex items-center justify-center flex-col space-x-6 mb-6">
          <img
          ...
          />
          <div>
            <p className="text-xl text-center font-medium text-gray-800">{user?.displayName}</p>
            ...
            <form onSubmit={handleUpdate} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="input border-2 rounded p-2 input-bordered w-full focus:ring-2 focus:ring-blue-500"
                  required
                />
              </div>
